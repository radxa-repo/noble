...
[![Update packages](https://github.com/radxa-repo/noble/actions/workflows/update.yaml/badge.svg)](https://github.com/radxa-repo/noble/actions/workflows/update.yaml)

## Content

* [Published GitHub Releases](https://radxa-repo.github.io/noble/pkgs.json)
* [File index](https://radxa-repo.github.io/noble/files.list)
...
curl https://radxa-repo.github.io/noble/install.sh | sh
```
